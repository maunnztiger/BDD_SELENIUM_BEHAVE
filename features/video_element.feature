...
Scenario:   Testing the video feature
    ...
    AND     a new frame with the according video opens up on the page
    AND     the blue menu button on the left top corner contains the textcontent "Video Menu ☰"
    ...
    AND     the video-menu-list appears again
    AND     the video-menu-list contains again all "7" video thumbnails
