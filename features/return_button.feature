Feature: Testing the pages buttons feature functionality

Scenario: testing the return-button functionality
    ...
    AND the front page has the headline "Homeoffice reporting tool"
    AND the title of the tab is again "Homeoffice 2024" 

Scenario: testing the create-button functionality 
    GIVEN the title of the tab is still "Homeoffice 2024" 
    WHEN the user clicks the menu-button on the front page
    AND the user clicks on the point "Men in Homeoffice Statistic"
    THEN the page "Homeoffice General Statistic" opens up
