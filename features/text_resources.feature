...
Scenario: write a little test for the the return-button functionality
    ...
    AND the user clicks on the menupoint "Text-Resourcen"
    THEN a page on the URL "http://127.0.0.1:5000/text_resources.html" opens up
    ...
    AND this Report has the subtitle: "Nr. 65, April 2021"
